<template>
  <div>
    ...
    >
      ...
      <!-- Sun -->
      <g fill="#fdd020">
        <!-- <path d="m168.335938 80-32-32" class="sunny" /> -->
        <path
          class="sunny"
        ...
        />
        <!-- <path d="m392.335938 80 32-32" class="sunny" /> -->
        <path
          class="sunny"
...
.sunny {
  animation: moveSun 5s ease-in forwards infinite;
}

.cloudy {
  animation: moveCloud 5s ease-out forwards infinite;
}
